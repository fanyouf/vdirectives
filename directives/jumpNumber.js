...
const jumpNumber = {
  bind: function(el, binding, vnode) {
    ...
    el.jump = function(vnode, startData = 0) {
      const rs = el.initNumber(vnode)
      if (!rs) {
      ...
      const dt = Math.ceil((el.targetData - el.startData) / step)
